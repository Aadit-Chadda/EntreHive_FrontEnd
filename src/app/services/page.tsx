        ...
        <div className="absolute inset-0 opacity-5">
          <div className="grid grid-cols-8 gap-4 h-full w-full p-8">
            {Array.from({ length: 24 }, (_, i) => (
              <div
                key={i}
                className="bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg animate-pulse"
                style={{ 
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white mx-auto mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">For Faculty</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">EcoTrack App</h3>
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg p-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">MedAssist</h3>
                <p className="text-gray-600 text-sm mb-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">StudyBuddy</h3>
                <p className="text-gray-600 text-sm mb-4">
