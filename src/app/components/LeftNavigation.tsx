          ...
          <div className="flex items-center flex-shrink-0 px-6 py-4 relative z-10" style={{borderBottom: '1px solid var(--border)'}}>
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-canva-sans" style={{color: 'var(--text-secondary)'}}>{user?.user_role === 'investor' ? 'Investor Network' : user?.user_role === 'mentor' ? 'Mentor Network' : 'Student Network'}</span>
              </div>
            </div>
          </div>
